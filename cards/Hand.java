...
public class Hand {
	...
	public void selectCard(int i) throws IncorrectNumberOfCardsException {
		...
		try {
			...
			throw new Exception("The card index given is invalid!");
		}
	...
	private List<Card> makeBundle(int sizeOfBundle) throws InvalidClassException {
	...
	public void addDefuseCard() {
		this.hand.add(new CardFactory().createCard("Defuse_card"));
	}
